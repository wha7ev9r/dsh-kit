...
The repository includes a manual GitHub Actions publish workflow. Configure the `NPM_TOKEN` repository secret before using it, then trigger the workflow from the Actions tab or with:
